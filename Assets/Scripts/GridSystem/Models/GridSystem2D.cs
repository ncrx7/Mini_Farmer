...
namespace NodeGridSystem.Models
{
    public class GridSystem2D<T>
    {
        ...
        /// <summary>
        /// EN: choose one In grid launch horizontal or vertical to make grid. (factory methods)
        ...
        public GridSystem2D(int width, int height, float cellSize, Vector3 origin, ACoordinateConverter coordinateConverter, bool debug)
        {
            this._width = width;
            this._height = height;
